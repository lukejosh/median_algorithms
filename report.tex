...
\section{Experimental Results}
    ...
    \subsection{Brute Force}
        \subsubsection{Number of operations}
            ...
            It must be noted that the data sets used to test the number of operations is not tested for uniqueness - a single value may appear more than once. This causes some amount of discrepency between the expected result and the actual result, but can mostly be corrected by increasing the maximum value a value can take to be sufficiently large. This can be seen in the source code in section 6.1.4, on line 97.
